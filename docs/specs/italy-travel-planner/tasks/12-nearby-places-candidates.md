...
- Revision(2026-08-20, 2차): "카페" 카테고리를 추가해 도시마다 카페 후보 2곳(가능하면 실제 유명 카페, 없으면 일반 에스프레소 카페)을 채우고 "카페 후보" 그룹을 추가했다. 관광지 후보도 도시당 2곳씩 더 늘렸다(모두 Wikimedia Commons에서 실존 확인).
